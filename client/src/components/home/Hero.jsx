...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl px-6 py-24 sm:px-8 lg:px-12">
        <div className="max-w-3xl">
          <h1 className="text-4xl font-bold leading-tight tracking-tight sm:text-5xl lg:text-7xl">
            Your Partner Beyond Your Trip
          </h1>
          <p className="mt-6 max-w-2xl text-base leading-8 text-slate-200 sm:text-lg">
           Vehicle Ownership,financing and Fleet management
              solutions designed to help Drivers build a better future
          </p>
